...
\textbf{Confidence calibration} is measured through four quantities derived from the models' predicted class probabilities,following the classical calibration evaluation framework\cite{guo2017calibration}:
