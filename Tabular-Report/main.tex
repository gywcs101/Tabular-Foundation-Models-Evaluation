...
For the multi-class mfeat datasets, we examine confusion matrices to identify systematic error patterns. \autoref{tab:error_patterns} lists the most frequent off-diagonal confusions across models.
