...
Beyond predictive accuracy, we examine whether models can assess the reliability of their own predictions through confidence calibration\cite{guo2017calibration}. Figure X compares the mean confidence assigned to correct versus incorrect predictions for each model.
...
This study systematically compares tabular foundation models (TFMs) against gradient-boosted decision trees (GBDTs) across three critical dimensions: predictive performance, computational consumption, and reliability.
